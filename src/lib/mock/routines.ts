...
export const mockRoutines: Routine[] = [
  ...
  },
  {
    ...
    description:
      "Timi's day-centre routine — sensory room, motor skills, shower, swimming, changing room, hub room, snack, puzzles and home",
    tags: ["extra"],
  ...
  },
  {
    ...
    description:
      "Timi's day-centre routine — sensory room, motor skills, shower, swimming, changing room, hub room, snack, puzzles, Timi's Car and home (items)",
    tags: ["extra"],
